package com.hanati.open_banking_backend.domain.user.service;
...
import com.hanati.open_banking_backend.domain.user.dto.request.UserRegisterRequest;
import com.hanati.open_banking_backend.domain.user.dto.response.UserRegisterResponse;
import com.hanati.open_banking_backend.domain.user.dto.response.UserResponse;
import com.hanati.open_banking_backend.domain.user.entity.User;
import com.hanati.open_banking_backend.domain.user.repository.UserRepository;
import com.hanati.open_banking_backend.global.util.UserGeneratorUtil;
...
public class UserService {
    ...
    public String getUserSeqNoByUserCi(String userCi) {
        User user = userRepository.findByUserCi(userCi).orElseThrow(() -> new IllegalArgumentException("존재하지 않는 사용자입니다."));
