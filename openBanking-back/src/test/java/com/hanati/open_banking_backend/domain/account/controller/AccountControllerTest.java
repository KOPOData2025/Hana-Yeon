...
import com.hanati.open_banking_backend.domain.account.dto.request.*;
import com.hanati.open_banking_backend.domain.account.dto.response.*;
...
class AccountControllerTest {
    ...
    void withdraw_Success() throws Exception {
        ...
        ReflectionTestUtils.setField(response, "tranAmt", "100000");
